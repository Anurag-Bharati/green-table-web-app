      ...
      <div className="flex items-center justify-between text-center sm:text-left sm:p-12">
        <div>
          <p className="flex-1 mb-0 max-w-xl text-3xl sm:text-4xl font-medium">
            <span className="text-[#94d82d]">Hungry?</span> Order From <span className="text-[#fccc3e]">Our Menu</span> & Have It Delivered To You.
          </p>
          <div className="my-4">
            <button className="py-3 px-3 bg-[#c0eb75] rounded-xl text-lg">View Menu</button>
          </div>
        </div>
      </div>
    </section>
